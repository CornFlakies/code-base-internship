...
class HelperFunctions:
    ...
    @staticmethod
    def triangle(xlength = 1, ylength = 1, xoffset = 0, yoffset=0):
        xlength = float(xlength)
        ylength = float(ylength)
        xoffset = float(xoffset)
        yoffset = float(yoffset)
 
        xvertex = [[xoffset, yoffset], [xoffset + xlength, yoffset]]
        yvertex = [[xoffset, yoffset], [xoffset, yoffset + ylength]]
        diagvertex = [[xoffset + xlength, yoffset], [xoffset, yoffset + ylength]]
        return xvertex, yvertex, diagvertex
